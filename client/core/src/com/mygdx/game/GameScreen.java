...
public class GameScreen implements Screen {
    ...
    public void drawButtons() {
        ...
        // "Fire" button
        TextButton btnFire = new TextButton("Fire", skin);
    ...
    // When a shot has been fired, either at this players board or the opponent, this method is called
    public void incomingFire(int x, int y, boolean isMainBoard, boolean isHit) {
        BoardGUI board;
        if (isMainBoard) {
